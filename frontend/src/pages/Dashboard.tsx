  ...
  return (
    <div className="p-4 md:p-6 max-w-6xl mx-auto space-y-4 md:space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        ...
        />
        <StatCard label="Budget agents" value={(data?.budget_total_agents ?? 0).toLocaleString('fr-FR') + ' FCFA'} sub="Somme des prix CFA" color="amber"
          icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 1.343-3 3v1h6v-1c0-1.657-1.343-3-3-3zm-7 7h14v2a2 2 0 01-2 2H7a2 2 0 01-2-2v-2zM7 11a5 5 0 0110 0v2H7v-2z"/></svg>}
        />
